...
class CreditCardMin:
    ...
    def balance(self):
        return self.driver.find_element_by_xpath("xpath=//*[@id='balanceInput']")

    def rate(self):
        return self.driver.find_element_by_xpath("xpath=//*[@id='interestInput']")

    def min_percentage(self):
        return self.driver.find_element_by_xpath("xpath=//*[@text='interest + 1% of balance']")

    def min_percentage_choose(self):
        return self.driver.find_element_by_xpath("xpath=//*[@text='3.0%']")


    def calculate_button(self):
        return self.driver.find_element_by_xpath("xpath=//*[@text='CALCULATE']")
